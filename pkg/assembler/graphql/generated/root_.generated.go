...
type ComplexityRoot struct {
	...
	CertifyCriticalityscore struct {
		Criticalityscore func(childComplexity int) int
		Source           func(childComplexity int) int
	}
	...
	Query struct {
		...
		Criticalityscore    func(childComplexity int, criticalityscoreSpec *model.CertifyCriticalityscoreSpec) int
	...
	Criticalityscore struct {
		DefaultScore             func(childComplexity int) int
		LegacyCommitFrequency    func(childComplexity int) int
		Collector                func(childComplexity int) int
		Origin                   func(childComplexity int) int
		LegacyContributorCount   func(childComplexity int) int
		LegacyRecentReleaseCount func(childComplexity int) int
		LegacyUpdatedIssuesCount func(childComplexity int) int
		RepoStarCount            func(childComplexity int) int
		TimeScanned              func(childComplexity int) int
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "CertifyCriticalityscore.criticalityscore":
		if e.complexity.CertifyCriticalityscore.Criticalityscore == nil {
			break
		}

		return e.complexity.CertifyCriticalityscore.Criticalityscore(childComplexity), true

	case "CertifyCriticalityscore.source":
		if e.complexity.CertifyCriticalityscore.Source == nil {
			break
		}

		return e.complexity.CertifyCriticalityscore.Source(childComplexity), true
	...
	case "Query.criticalityscore":
		if e.complexity.Query.Criticalityscore == nil {
			break
		}

		args, err := ec.field_Query_criticalityscore_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.Criticalityscore(childComplexity, args["criticalityscoreSpec"].(*model.CertifyCriticalityscoreSpec)), true
	...
	case "Criticalityscore.defaultScore":
		if e.complexity.Criticalityscore.DefaultScore == nil {
			break
		}

		return e.complexity.Criticalityscore.DefaultScore(childComplexity), true

	case "Criticalityscore.legacyCommitFrequency":
		if e.complexity.Criticalityscore.LegacyCommitFrequency == nil {
			break
		}

		return e.complexity.Criticalityscore.LegacyCommitFrequency(childComplexity), true

	case "Criticalityscore.collector":
		if e.complexity.Criticalityscore.Collector == nil {
			break
		}

		return e.complexity.Criticalityscore.Collector(childComplexity), true

	case "Criticalityscore.origin":
		if e.complexity.Criticalityscore.Origin == nil {
			break
		}

		return e.complexity.Criticalityscore.Origin(childComplexity), true

	case "Criticalityscore.legacyContributorCount":
		if e.complexity.Criticalityscore.LegacyContributorCount == nil {
			break
		}

		return e.complexity.Criticalityscore.LegacyContributorCount(childComplexity), true

	case "Criticalityscore.legacyRecentReleaseCount":
		if e.complexity.Criticalityscore.LegacyRecentReleaseCount == nil {
			break
		}

		return e.complexity.Criticalityscore.LegacyRecentReleaseCount(childComplexity), true

	case "Criticalityscore.legacyUpdatedIssuesCount":
		if e.complexity.Criticalityscore.LegacyUpdatedIssuesCount == nil {
			break
		}

		return e.complexity.Criticalityscore.LegacyUpdatedIssuesCount(childComplexity), true
	
	case "Criticalityscore.repoStarCount":
		if e.complexity.Criticalityscore.RepoStarCount == nil {
			break
		}

		return e.complexity.Criticalityscore.RepoStarCount(childComplexity), true

	case "Criticalityscore.timeScanned":
		if e.complexity.Criticalityscore.TimeScanned == nil {
			break
		}

		return e.complexity.Criticalityscore.TimeScanned(childComplexity), true
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		...
		ec.unmarshalInputCertifyCriticalityscoreSpec,
...
`, BuiltIn: false},
{Name: "../schema/certifyCriticalityscore.graphql", Input: `#
#
# Copyright 2023 The GUAC Authors.
#
# Licensed under the Apache License, Version 2.0 (the "License");
