...
type QueryResolver interface {
	...
	Criticalityscore(ctx context.Context, criticalityscoreSpec *model.CertifyCriticalityscoreSpec) ([]*model.CertifyCriticalityscore, error)
...
func (ec *executionContext) field_Query_criticalityscore_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 *model.CertifyCriticalityscoreSpec
	if tmp, ok := rawArgs["criticalityscoreSpec"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("criticalityscoreSpec"))
		arg0, err = ec.unmarshalOCertifyCriticalityscoreSpec2ᚖgithubᚗcomᚋguacsecᚋguacᚋpkgᚋassemblerᚋgraphqlᚋmodelᚐCertifyCriticalityscoreSpec(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
	args["criticalityscoreSpec"] = arg0
	return args, nil
}
...
func (ec *executionContext) _Query_criticalityscore(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_criticalityscore(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Criticalityscore(rctx, fc.Args["criticalityscoreSpec"].(*model.CertifyCriticalityscoreSpec))
	})
	if err != nil {
		ec.Error(ctx, err)
	}
	...
	res := resTmp.([]*model.CertifyCriticalityscore)
	fc.Result = res
	return ec.marshalNCertifyCriticalityscore2ᚕᚖgithubᚗcomᚋguacsecᚋguacᚋpkgᚋassemblerᚋgraphqlᚋmodelᚐCertifyCriticalityscoreᚄ(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_Query_criticalityscore(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "source":
				return ec.fieldContext_CertifyCriticalityscore_source(ctx, field)
			case "criticalityscore":
				return ec.fieldContext_CertifyCriticalityscore_criticalityscore(ctx, field)
			}
			return nil, fmt.Errorf("no field named %q was found under type CertifyCriticalityscore", field.Name)
		},
	}
	defer func() {
		if r := recover(); r != nil {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_criticalityscore_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
	...
	for i, field := range fields {
		...
		case "criticalityscore":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._Query_criticalityscore(ctx, field)
				return res
			}
