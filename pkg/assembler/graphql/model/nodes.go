...
type CertifyCriticalityscore struct {
	...
	Criticalityscore *Criticalityscore `json:"criticalityscore"`
}
type CertifyCriticalityscoreSpec struct {
	Source           *SourceSpec           `json:"source"`
	...
	//最近发布的数量
	LegacyRecentReleaseCount   *int     `json:"legacyRecentReleaseCount"`
	//更新问题数
	LegacyUpdatedIssuesCount   *int     `json:"legacyUpdatedIssuesCount"`
	//获得的星数  
