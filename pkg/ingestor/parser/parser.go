...
import (
	...
	"github.com/guacsec/guac/pkg/ingestor/parser/criticalityscore"
...
func init() {
	...
	_ = RegisterDocumentParser(criticalityscore.NewCriticalityscoreParser, processor.DocumentCriticalityscore)
}
