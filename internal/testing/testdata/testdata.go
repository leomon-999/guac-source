...
var (
	...
	//go:embed exampledata/test-criticalityscore.json
	CriticalityscoreExample []byte

	// Invalid criticalityscore
	//go:embed exampledata/invalid-criticalityscore.json
	CriticalityscoreInvalid []byte
